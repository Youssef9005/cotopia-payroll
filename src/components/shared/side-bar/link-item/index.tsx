...
export default function SidebarLinkItem({ href, icon, title, isActive } : SideBarLinkItem) {
    const linkStyle = "transition-all duration-200 ease-out hover:bg-gray-100 dark:hover:bg-gray-800 hover:rounded-md hover:border-l-4 hover:border-blue-600";
    const activeClass = "bg-gray-100 dark:bg-gray-800 rounded-md border-l-4 border-blue-600";
